...
export default function MenuNavegacion() {
  ...
  return (
    <nav className="sticky inset-0 z-50 backdrop-blur-xl">
      <div className="p-2 flex items-center gap-4 justify-between md:justify-around w-full max-w-[1200px] place-self-center">
        <MotionIconButton
          color="inherit"
